    ...
    <nav class="navbar" id="navbar">
      <div class="nav-container">
        ...
        <div class="nav-actions" style="position: relative; display: flex; align-items: center; gap: 8px;">
          ...
          <div class="nav-voice-volume-control" style="display: flex; align-items: center; gap: 6px; border: 1px solid rgba(0,0,0,0.08); background: rgba(0,0,0,0.02); padding: 0 8px; height: 32px; border-radius: 8px; transition: all 0.2s ease;">
            <span style="font-size: 10px; font-weight: 600; opacity: 0.7; user-select: none;">📢 Vol:</span>
            <input type="range" id="nav-voice-volume-slider" min="0" max="100" value="80" title="Voice Assistant Speaker Volume" style="width: 45px; height: 4px; cursor: pointer; accent-color: var(--accent); opacity: 0.8; transition: opacity 0.2s ease; padding: 0;" />
            <span id="nav-voice-volume-label" style="font-size: 9px; min-width: 20px; font-weight: 600; opacity: 0.7; user-select: none;">80%</span>
          </div>
